...
#define SPI_MISO_PIN 29 // pin to be connected to MISO (SDO)
#define SPI_MOSI_PIN 30  // pin to be connected to MOSI (SDA)
...
/* ADD_REG_CTRL_1 register defines the datarate and power mode selection. 
Converting it to 
100 Hz  0x57
400 Hz  0x77
1.344 kHz 0x97
...
/*CTRL_4 00000000 for Low resolution mode
00001000 for high resolution mode */

#define UC_ADD_REG_CTRL_1_CFG_VALUE                0x44 // Z enabled, 1.6 kHz
#define UC_ADD_REG_CTRL_2_CFG_VALUE                0x00
#define UC_ADD_REG_CTRL_3_CFG_VALUE                0x00
#define UC_ADD_REG_CTRL_4_CFG_VALUE                0x00
#define UC_ADD_REG_CTRL_5_CFG_VALUE                0x0
#define UC_ADD_REG_CTRL_6_CFG_VALUE                0x0
