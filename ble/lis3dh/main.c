...
/* How frequently the value needs to be updated*/
#define NOTIFICATION_INTERVAL           APP_TIMER_TICKS(1000)

/* application timer id with the name m_notification_timer_id by calling the APP_TIMER_DEF*/
APP_TIMER_DEF(m_notification_timer_id);

BLE_CUS_DEF(m_cus);                                                             /**<add a custom service instance called m_cus> */
...
/* hold the custom value we're going to notify to the nRF Connect app */
...
static ble_uuid_t m_adv_uuids[] = {{CUSTOM_SERVICE_UUID, BLE_UUID_TYPE_VENDOR_BEGIN }}; /**< Universally unique service identifiers. */
 ...
 */
 ...
 // This one increments or updates the value being passed through BLE
 // notification_timeout_handler which will increment the m_custom_value variable and then call ble_cus_custom_value_update 
static void notification_timeout_handler(void * p_context)
{
    ...
    m_custom_value++; // make changes to this variable here. 
   ...
   switch(p_evt->evt_type)
    {
        case BLE_CUS_EVT_NOTIFICATION_ENABLED:
            /* Application timer is created and the next step is to start the application timer when we receive the BLE_CUS_EVT_NOTIFICATION_ENABLED*/         
        ...
        case BLE_CUS_EVT_NOTIFICATION_DISABLED:
             /* Event timer to stop when we disconnect*/           
 ...
 static void services_init(void)
{
    ...
    cus_init.evt_handler                = on_cus_evt;
       ...
       /* These 2 lines allows us the device peer that they can write and/or read from the characteristic value 
...
static void lis3dh_value(bool state)
{
int i = 0;
...
//...........................
    ...
    // call sensor inti function after peer manager
