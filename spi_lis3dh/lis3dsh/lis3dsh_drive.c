...
void LIS3DSH_init(void)
{
	...
	//LIS3DSH_write_reg(ADD_REG_CTRL_1, UC_ADD_REG_CTRL_1_CFG_VALUE);
        ...
        LIS3DSH_write_reg(ADD_REG_CTRL_2, 0x00);
        LIS3DSH_write_reg(ADD_REG_CTRL_3, 0x00);
        LIS3DSH_write_reg(ADD_REG_CTRL_4, 0x0);
        LIS3DSH_write_reg(ADD_REG_CTRL_5, 0x0);
        LIS3DSH_write_reg(ADD_REG_CTRL_6, 0x0);
